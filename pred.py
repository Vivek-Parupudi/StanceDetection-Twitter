# Adapted from UCL Machine Reading - FNC-1 Submission (Riedel et al, 2017: http://arxiv.org/abs/1707.03264)
#
...
hidden_layer1 = tf.nn.dropout(tf.nn.relu(tf.contrib.layers.linear(features_pl, hidden_size)), keep_prob=keep_prob_pl)
hidden_layer2 = tf.nn.dropout(tf.nn.relu(tf.contrib.layers.linear(hidden_layer1, hidden_size)), keep_prob=keep_prob_pl)
